	...
	public static void further(){
	 ...
	 for(int i = 0; i < 10; i++){
	  ...
	  System.out.println("1 is " + String.valueOf(1)); //This says that it should be one,  
	   ...
	   //Here are some other conversion methods that might work 
	   String numberAsString = String.format ("%d", 5);
	   dict.insert(numberAsString, "Hi"); 
	   System.out.println("");
	   System.out.println("Value of 5:" + dict.lookup(numberAsString)); //For some reason this works, THIS IS the craziest thing ever! 
